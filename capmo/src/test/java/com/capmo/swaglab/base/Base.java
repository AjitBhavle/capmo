...
public class Base {
	...
	public void startReport() throws IOException {
		...
		extent.addSystemInfo("Host Name", "Selenium").addSystemInfo("Environment", "Wheather Automation Testing")
	...
	/*@BeforeMethod
	public void testLogger(Method method) throws IOException {
	...
	public void getResult(ITestResult result) throws IOException {
		if (result.getStatus() == ITestResult.FAILURE) {
			extentTest.get().log(LogStatus.FAIL, "Test Case Failed is " + result.getName());
			String imagePath = Helper.takeScreenShot(driver, "method_name");
			extentTest.get().log(LogStatus.FAIL, "ScreenShots Attached is : " + extentTest.get().addScreenCapture(imagePath));
